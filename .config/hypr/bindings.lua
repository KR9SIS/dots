...
O.bind("SUPER + SHIFT + F", "File manager", { focus = FILEMANAGER, args = "--new-window" })
O.bind("SUPER + ALT + SHIFT + F", "File manager (cwd)", { focus = FILEMANAGER, args = '--new-window "$(tmux-cwd)"' })
